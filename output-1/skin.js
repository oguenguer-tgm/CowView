...
// Generated Mo. Jul 15 08:48:41 2019
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._dropdown_menu.ggLeft=-226;
		...
		this._dropdown_scrollarea.ggLeft=-189;
		...
		this._dropdown_cloner.ggWidth = 169;
		this._dropdown_cloner.ggHeight = 24;
		...
		this._dropdown_menu_title_background.ggLeft=-189;
		...
		this._dropdown_menu_title.ggLeft=-188;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		} else
		{
			...
			this._ht_icon_text_cow=document.createElement('div');
			this._ht_icon_text_cow__text=document.createElement('div');
			this._ht_icon_text_cow.className='ggskin ggskin_textdiv';
			this._ht_icon_text_cow.ggTextDiv=this._ht_icon_text_cow__text;
			this._ht_icon_text_cow.ggId="ht_icon_text_cow";
			this._ht_icon_text_cow.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._ht_icon_text_cow.ggVisible=false;
			this._ht_icon_text_cow.className='ggskin ggskin_text ';
			this._ht_icon_text_cow.ggType='text';
			hs ='';
			hs+='height : 17px;';
			hs+='left : -44px;';
			hs+='opacity : 0.69999;';
			...
			hs+='width : 95px;';
			hs+='pointer-events:auto;';
			this._ht_icon_text_cow.setAttribute('style',hs);
			this._ht_icon_text_cow.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='padding: 4px 5px 4px 5px;';
			hs+='overflow: hidden;';
			this._ht_icon_text_cow__text.setAttribute('style',hs);
			this._ht_icon_text_cow__text.innerHTML=me.hotspot.title;
			this._ht_icon_text_cow.appendChild(this._ht_icon_text_cow__text);
			me._ht_icon_text_cow.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._ht_icon_text_cow.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._ht_icon_text_cow.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._ht_icon_text_cow);
			...
			this._image_2.onmouseover=function (e) {
				me._ht_icon_text_cow.style[domTransition]='none';
				me._ht_icon_text_cow.style.visibility=(Number(me._ht_icon_text_cow.style.opacity)>0||!me._ht_icon_text_cow.style.opacity)?'inherit':'hidden';
				me._ht_icon_text_cow.ggVisible=true;
			}
			this._image_2.onmouseout=function (e) {
				me._ht_icon_text_cow.style[domTransition]='none';
				me._ht_icon_text_cow.style.visibility='hidden';
				me._ht_icon_text_cow.ggVisible=false;
			}
	...
	function SkinCloner_dropdown_cloner_Class(nodeId, parent) {
		...
		this.elementMouseOver=[];
		this.__div=document.createElement('div');
		this.__div.setAttribute('style','position: absolute; left: 0px; top: 0px; width: 169px; height: 24px; visibility: inherit;');
		...
		this._dropdown_menu_text.onclick=function (e) {
			me.player.openNext("{"+me.ggNodeId+"}","$(ht)");
		}
